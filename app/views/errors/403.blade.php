...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>{{Config::get('irresistible.title')}} - Access Denied</title>
      ...
      <div id='wrap'>
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-12">
              <p class="text-center">
                <span class="text-inverse" style="font-size:4em;">Sorry!</span>
              </p>
              <p class="text-center">Access denied due to insufficient permissions.</p>
            </div>
