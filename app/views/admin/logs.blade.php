		...
		<div class="col-md-2">
            {{Form::open(array('route' => 'admin.log.search', 'method' => 'POST'))}}
				...
				<div class="form-group">
	            	...
	            	{{Form::text('beforeDate', null, array('class' => 'form-control', 'placeholder' => 'YYYY-MM-DD HH:MM:SS'))}}
	            </div>

				<div class="form-group">
					{{Form::label('fromDate', 'From Date', array('class' => 'control-label'))}}
	            	{{Form::text('fromDate', null, array('class' => 'form-control', 'placeholder' => 'YYYY-MM-DD HH:MM:SS'))}}
	            </div>
