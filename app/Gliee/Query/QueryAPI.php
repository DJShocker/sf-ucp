...
class QueryAPI
{
	...
	public function __construct($sServer, $iPort = 7777)
	{
		...
		//socket_set_timeout($this->rSocket, 0, 1000);
	...
	/**
	 *	Used to get the IP that is being queried
	 *
	 *	@return IP if queried, null else.
	 */
	public function getIP()
	{
		return isset($this->aServer[0]) ? gethostbyname($this->aServer[0]) : null;
	}
